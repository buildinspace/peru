...
class Module:
    ...
    def get_tree(self, runtime):
        ...
        warning = textwrap.dedent('''\
            WARNING: This project is using a recursive module, '{}'. The next
            version of peru is going to turn off recursive modules by default.
            To keep recursion, add "recursive: true" to the module definition.\
            '''.format(self.name))
        if not self.recursion_explicit:
            runtime.display.print(warning)
